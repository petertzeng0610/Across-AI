    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage className="text-foreground font-medium">WAF防禦管理</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">管理���的網站應用防火牆設定，保護您的網站免受各種網路攻擊威脅</p>
      </div>
                      ...
                      <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                          ...
                          <div className="col-span-3">
                            <span className="text-sm text-muted-foreground">���動</span>
                          </div>
                        </div>
                      </div>
                      <DialogFooter>
                    ...
                    <Tabs defaultValue="blacklist" className="w-full">
                      ...
                      <TabsContent value="blacklist" className="space-y-4">
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <h4 className="font-medium text-sm">��前黑名單 ({blacklist.length} 項)</h4>
