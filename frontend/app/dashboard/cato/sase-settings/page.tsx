...
export default function CatoSASESettings() {
  ...
  const [configuredDomains, setConfiguredDomains] = useState([
    {
      ...
      txtRecord: {
        type: "TXT",
        name: "_sase-verification.example.com",
        content: "sase-verify-abc123def456ghi789jkl012mno345pqr678stu901vwx234yz",
      },
    },
  ...
  const generateTxtRecord = (domain) => {
    ...
    return {
      type: "TXT",
      name: `_sase-verification.${domain}`,
      content: `sase-verify-${randomString}`,
    }
  }
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink href="/dashboard/cato">CATO Dashboard</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>SASE 設定</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-semibold tracking-tighter">
          SASE安全<span className="text-brand-primary">管理</span>
        </h1>
        <p className="mt-2 text-muted-foreground">管理您的 SASE 安全存取服務邊緣設定，保護您的網路免受各種威脅</p>
      </div>
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>配置您的 SASE 安全存取服務邊緣設定，包括域名管理和安全政策</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border gap-3 sm:gap-0 rounded-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">配置主要域名的SASE防護設定</p>
                  </div>
                </div>
                  ...
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                      <DialogHeader>
                        ...
                        <DialogDescription>請輸入您要配置SASE防護的主域名</DialogDescription>
                      </DialogHeader>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border gap-3 sm:gap-0 rounded-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">管理子域名的SASE防護配置</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 flex-shrink-0">
                  <Badge
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border rounded-lg gap-3 sm:gap-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium">SASE 政策</h3>
                ...
                <Dialog open={isWafPolicyDialogOpen} onOpenChange={setIsWafPolicyDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[800px] max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                      ...
                      <DialogDescription>配置黑名單、白名單和國別阻擋設定來加強您的網路安全防護</DialogDescription>
                    </DialogHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>常用的SASE管理操作</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
