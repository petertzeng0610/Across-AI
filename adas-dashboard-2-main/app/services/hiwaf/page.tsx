...
import { Shield, CheckCircle, Server, Globe, Zap, Lock, Users } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-3xl font-semibold tracking-tighter sm:text-4xl md:text-5xl">
          網站應用防火牆<span className="text-brand-primary">防禦</span>
        </h1>
        <p className="mt-4 text-foreground/80 text-lg font-normal max-w-2xl mx-auto">全球領先的網站應用防火牆服務</p>
        <p className="mt-4 text-muted-foreground font-normal max-w-4xl mx-auto leading-relaxed">
          網站應用防火牆
          提供企業級網站應用防火牆保護，透過全球分散式網路架構，即時阻擋惡意攻擊、SQL注入、跨站腳本攻擊等。結合器學習和專家規則，為您的網站提供全天候安全防護，確保業務持續運營。
        </p>
      </div>
        ...
        <div className="flex justify-center">
          <div className="bg-card rounded-lg p-8 shadow-lg max-w-4xl w-full border border-border">
            <div className="text-center mb-6">
              {/* Removed Cloudflare Logo */}
              <h3 className="text-xl font-medium text-foreground mb-2">WAF 架構圖</h3>
            </div>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="bg-muted p-4 rounded-lg">
                <Globe className="h-8 w-8 mx-auto mb-2 text-brand-primary" />
                <h4 className="text-foreground font-medium mb-2">全球用戶</h4>
                <p className="text-sm text-muted-foreground">來自世界各地的訪問請求</p>
              </div>
              <div className="bg-muted p-4 rounded-lg border-2 border-brand-primary">
                <Shield className="h-8 w-8 mx-auto mb-2 text-brand-primary" />
                <h4 className="text-foreground font-medium mb-2">WAF</h4>
                <p className="text-sm text-muted-foreground">全球邊緣節點即時防護</p>
              </div>
              <div className="bg-muted p-4 rounded-lg">
                <Server className="h-8 w-8 mx-auto mb-2 text-brand-primary" />
                <h4 className="text-foreground font-medium mb-2">源站伺服器</h4>
                <p className="text-sm text-muted-foreground">受保護的網站應用程式</p>
              </div>
            </div>
            <div className="mt-6 text-center text-muted-foreground text-sm">
              <p>透過全球網路的 300+ 個數據中心，在邊緣節點即時過濾惡意流量</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <ul className="space-y-6">
              <ServiceFeatureItem
                ...
                title="全球邊緣網路防護，300+ 個數據中心即時阻擋攻擊"
                description="利用遍布全球的邊緣網路，在最接近用戶的位置進行威脅檢測和阻擋，大幅降低延遲"
              />
              <ServiceFeatureItem
                icon={<Zap className="h-8 w-8 text-brand-primary" />}
                title="機器學習驅動的智能防護，自動適應新興威脅"
                description="結合機器學習演算法和專家規則庫，持續學習攻擊模式，自動更新防護策略"
              />
              <ServiceFeatureItem
                icon={<Lock className="h-8 w-8 text-brand-primary" />}
                title="OWASP Top 10 全面防護，涵蓋所常見攻擊類型"
                description="針對 SQL 注入、XSS、CSRF、DDoS 等攻擊提供全面防護，符合國際安全標準"
              />
              <ServiceFeatureItem
                icon={<Users className="h-8 w-8 text-brand-primary" />}
                title="24/7 專業安全團隊監控，即時威脅情報更新"
                description="安全專家團隊全天候監控全球威脅態勢，即時更新防護規則"
              />
            </ul>
          </div>
        </div>
      ...
      <section className="py-12 bg-card rounded-lg shadow-lg border border-border">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-semibold text-center mb-12 text-foreground">
            WAF<span className="text-brand-primary">方案</span>
          </h2>

          <div className="max-w-2xl mx-auto text-center">
            <Card className="bg-card border-border shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl font-medium text-foreground">WAF 防禦方案</CardTitle>
              ...
              <CardContent className="space-y-6">
                <ul className="space-y-3 text-left">
                  <li className="flex items-center">
                    ...
                    <span className="text-muted-foreground font-normal">全球 300+ 邊緣節點防護</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">機器學習威脅檢測</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">OWASP Top 10 全面防護</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">DDoS 攻擊防護</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">自訂防護規則</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">SSL/TLS 加密</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">即時威脅情報更新</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">24/7 專業技術支援</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0 text-brand-primary" />
                    <span className="text-muted-foreground font-normal">詳細安全分析報表</span>
                  </li>
                </ul>

                <div className="pt-6">
                  <Link href="/contact">
                    <Button className="w-full btn-primary text-white font-normal py-3 text-lg">立即啟用</Button>
                  </Link>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="space-y-0">
                ...
                {deviceTypeData.map((item, index) => (
                  ...
                  >
                    <div className="text-blue-600 hover:underline cursor-pointer">{item.type}</div>
              ...
              <div className="space-y-0">
                ...
                {referrerData.map((item, index) => (
                  <div
                    ...
                    className="grid grid-cols-2 gap-4 py-3 text-sm border-b border-border last:border-b-0 hover:bg-muted/30 transition-colors px-2"
                  >
                    <div className="text-blue-600 hover:underline cursor-pointer truncate" title={item.url}>
                      {item.url}
                    </div>
                    <div className="text-right text-foreground font-medium">{item.count}</div>
                  </div>
                ...
                <div className="max-h-64 overflow-y-auto">
                  {pathData.map((item, index) => (
                    <div
                      ...
                      className="grid grid-cols-2 gap-4 py-3 text-sm border-b border-border last:border-b-0 hover:bg-muted/30 transition-colors px-2"
                    >
                      <div className="text-blue-600 hover:underline cursor-pointer truncate" title={item.path}>
                        {item.path}
                      </div>
                      <div className="text-right text-foreground font-medium">{item.count}</div>
                    </div>
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    {locationData.map((item, index) => (
                      <div
                        ...
                        className="grid grid-cols-2 gap-4 py-3 text-sm border-b border-border last:border-b-0 hover:bg-muted/30 transition-colors px-2"
                      >
                        <div className="text-blue-600 hover:underline cursor-pointer truncate" title={item.location}>
                          {item.location}
                        </div>
                        <div className="text-right text-foreground font-medium">{item.count}</div>
                      </div>
    ...
    <div className="relative w-full h-full bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg overflow-hidden border border-blue-200">
      ...
      <div className="absolute top-4 left-4 flex flex-col space-y-2 z-30">
        <button
          ...
          className="w-10 h-10 bg-white/90 backdrop-blur-sm border border-blue-200 rounded-lg flex items-center justify-center text-blue-600 hover:bg-blue-50 hover:border-blue-300 shadow-lg transition-all duration-200"
          title="放大"
        >
        ...
        <button className="w-10 h-10 bg-blue-600 border border-blue-700 rounded-lg flex items-center justify-center text-white hover:bg-blue-700 shadow-lg transition-all duration-200">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      {/* 縮放級別顯示 */}
      <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg text-sm text-blue-600 font-medium border border-blue-200 shadow-lg z-30">
        zoom: {zoomLevel}
      </div>

      {/* 圖例 */}
      <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-2xl border border-blue-200 z-30">
        <div className="text-sm font-semibold text-blue-800 mb-3">流量強度</div>
      ...
      {selectedLocation && (
        <div className="absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-40">
          <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl border border-blue-100">
            <div className="flex justify-between items-start mb-6">
              <h3 className="text-xl font-bold text-blue-800">{selectedLocation.location}</h3>
              <button
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                <span className="text-blue-700 font-medium">總訪問次數:</span>
                <span className="font-bold text-blue-900">{selectedLocation.count}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-gray-700 font-medium">流量等級:</span>
              ...
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                <span className="text-green-700 font-medium">威脅等級:</span>
